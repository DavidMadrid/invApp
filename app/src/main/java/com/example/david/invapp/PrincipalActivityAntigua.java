...
public class PrincipalActivityAntigua extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_antiguo);
     ...
     //  Recuento ubicacion = (Recuento)getIntent().getSerializableExtra("ubicacion");
      //  String articulo = getIntent().getStringExtra("articulo");
       ...
       // resultados.add(ubicacion);
        ...
        server.listaPrincipalRecuento(loginApp,adapter2);//para cargar la lista entera
        ...
        adapter2.setOnItemClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Recuento recuento = (Recuento) view.getTag();
               // Toast.makeText(PrincipalActivity.this, recuento.getRecuento(), Toast.LENGTH_SHORT).show();
               /*Intent i = new Intent(PrincipalActivity.this, DatosActivity.class);
                i.putExtra("RESULT", recuento);
                startActivity(i);*/

                Intent intent = new Intent(PrincipalActivityAntigua.this, EntradaActivity.class);
